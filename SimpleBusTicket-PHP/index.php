    ...
    <div id="block">
        ...
        <section id="about">
            <div>
                ...
                <p>
                Welcome to Simple Bus Ticket Booking System, your one-stop solution for convenient and hassle-free bus ticket reservations. We understand the importance of seamless travel experiences, and our platform is designed to simplify the process of booking bus tickets for your journeys.

At Simple Bus Ticket Booking System, we strive to provide a user-friendly interface that enables travelers to effortlessly browse, select, and book bus tickets to their desired destinations. Whether you're planning a short commute or a long-distance trip, our platform offers a wide range of options to cater to your specific needs.
               </p>
            </div>
        </section>
        <section id="contact">
